...
; CHECK-NEXT:    li r7, 5
; CHECK-NEXT:    li r9, 6
; CHECK-NEXT:    li r10, 13
; CHECK-NEXT:    li r11, 9
; CHECK-NEXT:    li r12, 10
; CHECK-NEXT:    .p2align 4
; CHECK-NEXT:  .LBB2_2: #
...
; CHECK-NEXT:    cmpldi r4, 1
; CHECK-NEXT:    li r6, 1
; CHECK-NEXT:    isel r5, r4, r6, gt
; CHECK-NEXT:    mtctr r5
; CHECK-NEXT:    addi r3, r3, 3997
; CHECK-NEXT:    li r5, 0
; CHECK-NEXT:    li r7, 2
; CHECK-NEXT:    li r8, 5
...
; CHECK-NEXT:    li r6, 1
; CHECK-NEXT:    isel r6, r5, r6, gt
; CHECK-NEXT:    mtctr r6
; CHECK-NEXT:    addi r3, r3, 4010
; CHECK-NEXT:    addi r4, r4, 4010
; CHECK-NEXT:    li r6, 0
; CHECK-NEXT:    li r7, -9
; CHECK-NEXT:    li r8, -5
; CHECK-NEXT:    li r9, -1
...
; CHECK-NEXT:  # %bb.1:
; CHECK-NEXT:    addis r6, r2, .LC0@toc@ha
; CHECK-NEXT:    ld r7, .LC0@toc@l(r6)
; CHECK-NEXT:    cmpldi r4, 1
; CHECK-NEXT:    li r6, 1
; CHECK-NEXT:    isel r10, r4, r6, gt
; CHECK-NEXT:    ld r4, 0(r7)
; CHECK-NEXT:    lis r7, 21845
; CHECK-NEXT:    ori r7, r7, 21845
; CHECK-NEXT:    sldi r7, r7, 32
; CHECK-NEXT:    oris r7, r7, 21845
; CHECK-NEXT:    mtctr r10
; CHECK-NEXT:    addi r5, r3, 4000
; CHECK-NEXT:    li r3, 0
; CHECK-NEXT:    addi r4, r4, -1
; CHECK-NEXT:    ori r7, r7, 21846
; CHECK-NEXT:    li r8, 3
; CHECK-NEXT:    li r9, 2
; CHECK-NEXT:    li r10, 5
; CHECK-NEXT:    li r11, 9
...
; CHECK-NEXT:  .LBB6_4: #
; CHECK-NEXT:    lbzu r0, 1(r4)
; CHECK-NEXT:    mulld r0, r0, r7
; CHECK-NEXT:    mulhdu r0, r0, r8
; CHECK-NEXT:    cmplwi r0, 1
; CHECK-NEXT:    beq cr0, .LBB6_2
; CHECK-NEXT:  # %bb.5: #
; CHECK-NEXT:    rlwinm r0, r0, 0, 24, 31
...
; CHECK-NEXT:  # %bb.1:
; CHECK-NEXT:    clrldi r5, r4, 32
; CHECK-NEXT:    addi r4, r3, 4001
; CHECK-NEXT:    addi r3, r3, 4000
; CHECK-NEXT:    mtctr r5
; CHECK-NEXT:    xxlxor f1, f1, f1
; CHECK-NEXT:    li r5, 21
