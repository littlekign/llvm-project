...
; RV32I-LABEL: dont_lower_srem_one:
; RV32I:       # %bb.0:
; RV32I-NEXT:    addi sp, sp, -32
; RV32I-NEXT:    .cfi_def_cfa_offset 32
; RV32I-NEXT:    sw ra, 28(sp)
...
; RV32I-NEXT:    ret
;
; RV32IM-LABEL: dont_lower_srem_one:
; RV32IM:       # %bb.0:
...
; RV32IM-NEXT:    ret
;
; RV64I-LABEL: dont_lower_srem_one:
; RV64I:       # %bb.0:
; RV64I-NEXT:    addi sp, sp, -48
; RV64I-NEXT:    .cfi_def_cfa_offset 48
; RV64I-NEXT:    sd ra, 40(sp)
...
; RV64I-NEXT:    ret
;
; RV64IM-LABEL: dont_lower_srem_one:
; RV64IM:       # %bb.0:
...
; RV32I-LABEL: dont_lower_urem_i16_smax:
; RV32I:       # %bb.0:
; RV32I-NEXT:    addi sp, sp, -32
; RV32I-NEXT:    .cfi_def_cfa_offset 32
; RV32I-NEXT:    sw ra, 28(sp)
...
; RV32I-NEXT:    ret
;
; RV32IM-LABEL: dont_lower_urem_i16_smax:
; RV32IM:       # %bb.0:
...
; RV32IM-NEXT:    ret
;
; RV64I-LABEL: dont_lower_urem_i16_smax:
; RV64I:       # %bb.0:
; RV64I-NEXT:    addi sp, sp, -48
; RV64I-NEXT:    .cfi_def_cfa_offset 48
; RV64I-NEXT:    sd ra, 40(sp)
...
; RV64I-NEXT:    ret
;
; RV64IM-LABEL: dont_lower_urem_i16_smax:
; RV64IM:       # %bb.0:
