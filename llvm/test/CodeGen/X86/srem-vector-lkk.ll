...
; SSE-LABEL: dont_lower_srem_power_of_two:
; SSE:       # %bb.0:
...
; SSE-NEXT:    retq
;
; AVX1-LABEL: dont_lower_srem_power_of_two:
; AVX1:       # %bb.0:
...
; AVX1-NEXT:    retq
;
; AVX2-LABEL: dont_lower_srem_power_of_two:
; AVX2:       # %bb.0:
...
; SSE-NEXT:    retq
;
; AVX1-LABEL: dont_lower_srem_one:
; AVX1:       # %bb.0:
...
; AVX1-NEXT:    retq
;
; AVX2-LABEL: dont_lower_srem_one:
; AVX2:       # %bb.0:
...
; SSE-LABEL: dont_lower_urem_i16_smax:
; SSE:       # %bb.0:
...
; SSE-NEXT:    retq
;
; AVX-LABEL: dont_lower_urem_i16_smax:
; AVX:       # %bb.0:
...
; SSE-NEXT:    retq
;
; AVX1-LABEL: dont_lower_srem_i64:
; AVX1:       # %bb.0:
...
; AVX1-NEXT:    retq
;
; AVX2-LABEL: dont_lower_srem_i64:
; AVX2:       # %bb.0:
